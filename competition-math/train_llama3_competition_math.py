...
def train_llama3_sat_math():
    ...
    model, tokenizer = FastLanguageModel.from_pretrained(
        model_name = "knazarali3/llama3_sat_math", 
    ...
    model.push_to_hub("knazarali3/llama3_COMPETITION_MATH", token = "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") # Online saving
    tokenizer.push_to_hub("knazarali3/llama3_COMPETITION_MATH", token = "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") # Online saving
